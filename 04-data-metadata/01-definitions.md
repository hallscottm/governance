# Data/Metadata Layer — Definitions
...
Database/Schema, layer 3) and how it moves through pipelines
(Workflow/Process, layer 5, not yet built). This layer is also where the
...
- **Database Schema** — see [03-system-architecture/01-definitions.md#sysarch-database-schema](../03-system-architecture/01-definitions.md#sysarch-database-schema)
- **Database** — see [03-system-architecture/01-definitions.md#sysarch-database](../03-system-architecture/01-definitions.md#sysarch-database)
...
feeds this layer's contribution to the cross-cutting Risk Tier
...
- [x] Modular — cross-layer references (Database Schema, Database, Archive, Environment lifecycle) are links, not restatements
