# Data/Metadata Layer — Conventions
...
(Workflow/Process, layer 5, not yet drafted).
...
tag-key kebab-case rule as prior layers' Tag Key Naming Convention,
applied to this layer's single most load-bearing tag.
