# Data/Metadata Layer — Tooling / Implementation
...
Same posture as all three prior layers: capability categories only, no
specific product/vendor recommendations — deferred entirely per explicit
choice, confirmed again for this layer. Notably, this is the category the
...
to no-specific-product per this layer's confirmed posture.
