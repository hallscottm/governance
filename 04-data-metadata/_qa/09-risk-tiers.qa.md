...
## 2026-09-22 — Q9.1: Determining factors, and resolving the cross-layer Data-sensitivity factor

**Context:** This is the layer three prior layers have been carrying a
...
layers in the same session (Infrastructure, Networking, System
Architecture) to source their Data-sensitivity factor from this layer's
...
- 02-networking/09-risk-tiers.md: new Data sensitivity row added (this
  layer previously excluded the factor entirely, relying on network
