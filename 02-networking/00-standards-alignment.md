# Networking Domain — Standards Alignment
...
Scope per 00-framework/domain-axis-definition.md: connectivity,
...
| **IEEE 802 series** | IEEE | Link-domain standards: 802.3 (Ethernet), 802.11 (Wi-Fi), 802.1Q (VLAN tagging) |
...
- **DAMA-DMBOK** — not applicable to this domain (data governance, not
  networking)
