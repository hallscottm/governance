# Data/Metadata Domain — Risk Tiers
...
This is the domain that owns the Data-sensitivity factor referenced
...
Unlike the three prior domains, Sensitivity Level here is not just *a*
factor among several — it's the field every other domain's Data-sensitivity
...
- [x] Modular — this domain's factor is now the authoritative source
      three other domains reference, not a duplicate parallel scale
