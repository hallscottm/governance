# Data/Metadata Domain — Access Rules
...
- [x] Easy to replace — Data Owner/Data Governance Council remain owned here (by design, see cross-cutting/roles-and-departments/01-definitions.md's Referenced Terms); the generic role pattern (Requester/Approver/etc.) is now owned centrally, retrofitted 2026-09-22
